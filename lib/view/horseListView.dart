...
class _HorseListViewState extends State<HorseListView> {
  ...
  void initState() {
    ...
    HorsesCard horsesCard1 = HorsesCard(Horse("Idalgo", "5", "brun","Appaloosa" , "male", "Course", "image"), selectedHorseList);
    HorsesCard horsesCard2 = HorsesCard(Horse("magic", "20", "rousse", "Pottok", "female", "obstacle", "image"), selectedHorseList);
    HorsesCard horsesCard3 = HorsesCard(Horse("Phoebus", "7", "blanche", "Percheron", "female", "course", "image"), selectedHorseList);
    HorsesCard horsesCard4 = HorsesCard(Horse("Kiss", "10", "noire", "Akhal-Téké", "female", "course", "image"), selectedHorseList);
    HorsesCard horsesCard5 = HorsesCard(Horse("Odin", "12", "noire", "Haflinge", "male", "course", "image"), selectedHorseList);
